...
def open_login_window():
    ...
    tkinter.Label(window, text="Enter the email").place(x=15, y=10)
    emailtxt = tkinter.Entry(window)
    emailtxt.place(x=200, y=10)

    tkinter.Label(window, text="Enter the password").place(x=15, y=40)
    passwordtxt = tkinter.Entry(window, show="*")
    ...
    tkinter.Button(window, text="LOGIN", command=loginvalues).place(x=160, y=80)
